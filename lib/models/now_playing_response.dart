...
class NowPlayingResponse {
  ...
  factory NowPlayingResponse.fromJson(Map<String, dynamic> json) =>
    NowPlayingResponse(
      date: Dates.fromJson(json["dates"]), 
      page: json["page"], 
...
class Dates{
  ...
  factory Dates.fromJson(Map<String, dynamic> json) => Dates(
    maximum: DateTime.tryParse(json["maximum"]?.toString() ?? '') ?? DateTime(1900),
    minimum: DateTime.tryParse(json["minimum"]?.toString() ?? '') ?? DateTime(1900),
  );
